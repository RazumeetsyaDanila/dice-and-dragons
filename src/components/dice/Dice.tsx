                                    ...
                                    return <svg onClick={rerollDice} className={classes.life1Dice}
                                        ...
                                        <g transform="translate(173,160)">
                                            <g transform="translate(12.8, 12.8) scale(0.6, 0.6) rotate(0, 128, 128)">
                                                <circle cx="128" cy="128" r="128" fill="#c1121f" fillOpacity="1"></circle>
                                                <circle stroke="#dfdfdf" strokeOpacity="1" fill="#c1121f" fillOpacity="1" strokeWidth="18" cx="128" cy="128" r="101"></circle>
                                                <path className={classes.notChangeFill} fill="#dfdfdf" fillOpacity="1" d="M128 204c16-24 68-78 68-94 0-24-20-39.824-36-40-16 0-32 10-32 30 0-20-16-30-32-30-16-.176-36 16-36 40 0 16 52 70 68 94z"></path>
                                            </g>
                                        </g>
                                    </svg>
                                case 'magic':
                                    ...
                                    return <svg onClick={rerollDice} className={classes.magic1Dice}
                                        ...
                                        <g transform="translate(173,160)">
                                            <g transform="translate(12.8, 12.8) scale(0.6, 0.6) rotate(0, 128, 128)">
                                                <circle cx="128" cy="128" r="128" fill="#c1121f" fillOpacity="1"></circle>
                                                <circle stroke="#dfdfdf" strokeOpacity="1" fill="#c1121f" fillOpacity="1" strokeWidth="18" cx="128" cy="128" r="101"></circle>
                                                <path className={classes.notChangeFill} fill="#dfdfdf" fillOpacity="1" d="M99.016 83.18c0 27.973 28.984 32.635 28.984 55.946 0 9.325-9.661 23.312-24.153 23.312-14.492 0-24.153-13.987-14.492-37.298-14.491 9.324-19.322 18.649-19.322 27.973 0 23.312 24.153 46.623 57.967 46.623 33.813 0 57.966-13.987 57.966-41.96.216-41.378-49.4-55.2-62.797-74.597-9.66-13.987-4.83-23.311 4.83-32.636-19.321 4.663-28.983 17.717-28.983 32.636z"></path>
                                            </g>
                                        </g>
                                    </svg>
                                case 'roar':
                                    ...
                                    return <svg onClick={rerollDice} className={classes.shield1Dice}
                                        ...
                                        <g transform="translate(173,160)">
                                            <g transform="translate(12.8, 12.8) scale(0.6, 0.6) rotate(0, 128, 128)">
                                                <circle cx="128" cy="128" r="128" fill="#c1121f" fillOpacity="1"></circle>
                                                <circle stroke="#dfdfdf" strokeOpacity="1" fill="#c1121f" fillOpacity="1" strokeWidth="18" cx="128" cy="128" r="101"></circle>
                                                <path className={classes.notChangeFill} fill="#dfdfdf" fillOpacity="1" d="M64 94l64-38 64 38c0 32-48 108-64 108-16 .25-64-76-64-108z"></path>
                                            </g>
                                        </g>
                                    </svg>
                            }
